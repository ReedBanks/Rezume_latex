...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Location: Tamale, Northern Region, Ghana \\ % row = 1, col = 2
   \href{https://linkedin.com/in/adam-elijah-60341a241}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/Elijah-Adam}{\uline{GitHub}} $|$ % row = 2, col = 1
   Email: \href{mailto:adamelijah4@gmail.com}{\uline{adonmapin@gmail.com} $|$ % row = 2, col = 2
  Mobile: 0598648334 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\small{
  I am a dedicated and skilled  web developer with a few months exeprience in \textbf{HTML, CSS, JavaScript, and PHP}. I have knowledge of popular framework \textbf{React} and experience with REST APIs 
}
%--------------------------------------------
